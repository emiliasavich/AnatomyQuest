      ...
      <section className="relative overflow-hidden bg-gradient-to-b from-aq-sage to-aq-warm">
        ...
        <div className="mx-auto max-w-6xl px-6 pb-20 pt-16 sm:px-8 sm:pb-24 sm:pt-20 lg:px-12">
          ...
          <p className="mt-6 max-w-2xl text-lg leading-relaxed text-stone-600 sm:text-xl">
            ...
            <em>why</em> each structure exists — so you remember it for life.
          </p>
          ...
          <div className="grid items-start gap-10 lg:grid-cols-2 lg:gap-16">
            <div>
              ...
              <p className="mt-4 text-stone-600 leading-relaxed">
                ...
                cardiovascular systems — no isolated facts.
              </p>
              <p className="mt-3 text-sm text-stone-500">
                Mnemonic:{" "}
                <em className="text-stone-600">
                  Learning Small Notes About Bones
                </em>
              </p>
              <Link
                href="/getting_started/effective_learning_methods/learning_bones"
                className="mt-6 inline-flex items-center gap-2 text-sm font-semibold text-aq-primary hover:underline"
              >
            ...
            <div className="space-y-3">
              {FIVE_STEPS.map((step, i) => (
                <div
                  key={step.name}
                  className="flex items-start gap-4 rounded-xl border border-stone-200/80 bg-white/80 px-5 py-4 backdrop-blur-sm"
                >
                  <span
                    className={`flex h-8 w-8 shrink-0 items-center justify-center rounded-lg text-sm font-bold text-white ${step.bg}`}
                  >
                    {i + 1}
                  </span>
                  <div>
                    <p className={`font-semibold ${step.color}`}>{step.name}</p>
        ...
        <div className="mx-auto max-w-6xl px-6 py-16 sm:px-8 sm:py-20 lg:px-12">
          <div className="grid gap-10 lg:grid-cols-2 lg:gap-16">
            ...
            <div>
              ...
              <p className="mt-4 text-stone-600 leading-relaxed">
                Built by its community — fix a mistake, improve an explanation,
                or write a new section. No technical skills required.
              </p>
              <Link
                href="/contribute"
