...
export default function BicepsBrachiiPage() {
  const sections: DetailSection[] = getDetails("muscles", "biceps_brachii");
  ...
  return (
    <ContentLayout
      ...
      breadcrumbs={[
        ...
        { label: "Muscles", href: "/muscular_system/muscles" },
        { label: "Biceps Brachii" },
      ]}
    >
      <p className="mb-6 leading-relaxed text-stone-600">
        The <strong className="text-stone-800">biceps brachii</strong> is a
        two-headed muscle of the anterior compartment of the arm. It acts
        primarily as a flexor of the forearm at the elbow and a powerful
