...
export default function MotorNeuronPage() {
  const sections: DetailSection[] = getDetails("neurons", "motor_neuron");
  ...
  return (
    <ContentLayout
      ...
      breadcrumbs={[
        ...
        { label: "Neurons", href: "/nervous_system/neurons" },
        { label: "Motor Neuron" },
      ]}
    >
      <p className="mb-6 leading-relaxed text-stone-600">
        A <strong className="text-stone-800">motor neuron</strong> (motoneuron)
        is a nerve cell whose cell body is located in the spinal cord or
        brainstem and whose axon projects to skeletal muscles to control
        voluntary movement.
      </p>
