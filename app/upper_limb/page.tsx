...
export default function UpperLimbPage() {
  return (
    <div className="min-w-0 flex-1 space-y-6">
      <Breadcrumbs items={[{ label: "Home", href: "/" }, { label: "Upper Limb" }]} />
      <h1 className="font-serif text-2xl font-semibold tracking-tight text-stone-900 sm:text-3xl">Upper Limb</h1>
