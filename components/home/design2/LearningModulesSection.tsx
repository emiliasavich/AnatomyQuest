...
export function LearningModulesSection() {
  ...
  return (
    <section className="rounded-2xl border border-stone-200 bg-white px-6 py-6 shadow-sm sm:px-8 sm:py-7">
      ...
      {links && (
        <p className="mt-3 text-stone-600">
          ...
          <Link href={links.learningBonesHref} className="font-medium text-aq-red hover:underline">
            Learning Bones
          </Link>
          , and then apply it on any bone page (e.g.{" "}
          <Link href={links.humerusHref} className="font-medium text-aq-red hover:underline">
            Humerus
          </Link>
          ).
        </p>
